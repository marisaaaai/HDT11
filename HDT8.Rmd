...
train<-datos[corte,]
test<-datos[-corte,]
modeloCaret <- train(SalePrice~., data=train, method="nnet", trace=F)
test$prediccionCaret<-predict(modeloCaret, newdata = test[,1:32])
